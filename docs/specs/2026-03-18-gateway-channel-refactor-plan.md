...
| `agentos/adapters/plugins/feishu/channel.py` | 小改 | 适配 Gateway 新 API |
...
**Files:**
- Modify: `agentos/adapters/plugins/feishu/channel.py`
...
```bash
git add agentos/adapters/plugins/feishu/channel.py
