...
```bash
python3 .agentos/skills/union-search-plus/scripts/union_search_plus.py \
  "用户问题" \
  --group preferred \
  --limit 5 \
  --timeout 60
...
```bash
python3 .agentos/skills/union-search-plus/scripts/assess_coverage.py \
...
```bash
python3 .agentos/skills/union-search-plus/scripts/merge_search_results.py \
