...
from sensenova_claw.capabilities.skills.models import InstallRequest, SkillInvokeRequest
from sensenova_claw.capabilities.skills.arg_substitutor import substitute_arguments
