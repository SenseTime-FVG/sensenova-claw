...
class AgentRegistry:
    ...
    def __init__(self, sensenova_claw_home: str | Path | None = None):
        self._agents: dict[str, AgentConfig] = {}
        self._sensenova_claw_home = Path(sensenova_claw_home) if sensenova_claw_home else None
    ...
    def _build_agent_from_dict(
        ...
        {sensenova_claw_home}/agents/{agent_id}/SYSTEM_PROMPT.md 文件中。
        """
    ...
    def _load_system_prompt(self, agent_id: str) -> str:
        """从 {sensenova_claw_home}/agents/{agent_id}/SYSTEM_PROMPT.md 读取 system prompt"""
        if not self._sensenova_claw_home:
            return ""
        prompt_file = self._sensenova_claw_home / "agents" / agent_id / SYSTEM_PROMPT_FILENAME
