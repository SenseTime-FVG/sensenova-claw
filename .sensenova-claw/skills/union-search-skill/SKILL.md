...
| 平台 | 描述 | 文档 |
|------|------|------|
| **小红书** | 笔记搜索，支持过滤排序 | [README.md](scripts/xiaohongshu/README.md) |
| **抖音** | 视频搜索，支持过滤选项 | [DOUYIN_README.md](scripts/douyin/DOUYIN_README.md) |
| **Bilibili** | 视频搜索，双API支持 | [README.md](scripts/bilibili/README.md) |
| **Twitter** | 帖子和时间线搜索 | [README.md](scripts/twitter/README.md) |
| **YouTube** | 视频、评论搜索 | [YOUTUBE_README.md](scripts/youtube/YOUTUBE_README.md) |
| **知乎** | 中文问答平台 | [README.md](scripts/zhihu/README.md) |
| **微博** | 中文社交媒体搜索（需 TikHub API） | [WEIBO_README.md](scripts/weibo/WEIBO_README.md) |
| **微信** | 微信公众号搜索 | [WECHAT_README.md](scripts/wechat/WECHAT_README.md) |
| **头条** | 今日头条搜索 | [TOUTIAO_README.md](scripts/toutiao/TOUTIAO_README.md) |
| **小宇宙FM** | 播客搜索 | [XIAOYUZHOUFM_README.md](scripts/xiaoyuzhoufm/XIAOYUZHOUFM_README.md) |
| **集思录** | 金融投资信息搜索 | [JISILU_README.md](scripts/jisilu/JISILU_README.md) |
...
| **百度** | 百度搜索引擎（支持 API 和无 API 两种模式） | [BAIDU_README.md](scripts/baidu/BAIDU_README.md) |
| **搜狗** | 搜狗搜索引擎 | [SOGOU_README.md](scripts/sogou/SOGOU_README.md) |
| **360搜索** | 360搜索引擎 | [SO360_README.md](scripts/so360/SO360_README.md) |
| **Yandex** | 俄语搜索引擎（需 SerpAPI Key） | [YANDEX_README.md](scripts/yandex/YANDEX_README.md) |
| **Ecosia** | 环保搜索引擎（需代理） | [ECOSIA_README.md](scripts/ecosia/ECOSIA_README.md) |
| **Qwant** | 欧洲隐私搜索引擎（需代理） | [QWANT_README.md](scripts/qwant/QWANT_README.md) |
| **Startpage** | 隐私搜索引擎 | [STARTPAGE_README.md](scripts/startpage/STARTPAGE_README.md) |

### 其他搜索工具

| 工具 | 描述 | 文档 |
|------|------|------|
| **联合搜索** | 统一多平台搜索接口 | [README.md](scripts/union_search/README.md) |
| **图片搜索** | 多平台批量图片下载 (含火山引擎) | [UNION_IMAGE_SEARCH_README.md](scripts/union_image_search/UNION_IMAGE_SEARCH_README.md) |
| **RSS** | 订阅源内容搜索 | [RSS_SEARCH_README.md](scripts/rss_search/RSS_SEARCH_README.md) |
| **Jina** | 网页内容提取 | [README.md](scripts/jina/README.md) |
| **URL转Markdown** | 网页转Markdown格式 | [README.md](scripts/url_to_markdown/README.md) |
| **Wolfram** | 计算知识引擎（需代理） | [WOLFRAM_README.md](scripts/wolfram/WOLFRAM_README.md) |
| **下载器** | 基于 yt-dlp 的视频/音频下载 | [DOWNLOADER_README.md](scripts/downloader/DOWNLOADER_README.md) |
| **CLI** | 命令行统一搜索入口 | [README.md](scripts/cli/README.md) |
