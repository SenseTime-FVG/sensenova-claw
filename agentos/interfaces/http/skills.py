...
from agentos.capabilities.skills.models import InstallRequest, SkillInvokeRequest
from agentos.capabilities.skills.arg_substitutor import substitute_arguments
