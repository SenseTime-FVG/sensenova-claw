...
_WINDOWS_TOAST_APP_ID = "AgentOS.DesktopNotification"
_WINDOWS_TOAST_SHORTCUT_NAME = "AgentOS Notifications.lnk"
_WINDOWS_TOAST_SHORTCUT_DESCRIPTION = "AgentOS desktop notifications"
...
public static class AgentOSShortcutInstaller
{
...
def _build_windows_toast_script(title: str, body: str, powershell_path: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "if (-not ('AgentOSShortcutInstaller' -as [type])) {",
            ...
            "}",
            "",
            "[AgentOSShortcutInstaller]::EnsureShortcut(",
            "    $shortcutPath,",
            "    $shortcutTarget,",
            "    $shortcutArguments,",
            "    $shortcutDescription,",
